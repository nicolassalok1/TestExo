...
try:
    from AmericanExo.Lookback.aux_functions import (
    ...
    # Allow importing when the package root is not on sys.path (e.g. executing from Lookback/)
    from aux_functions import (  # type: ignore
        const_tri_diag_mat_solve,
        get_result,
        st,
        delta_m,
